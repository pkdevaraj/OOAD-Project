...
public class destinationmap extends FragmentActivity implements OnMapReadyCallback,View.OnClickListener,GoogleMap.OnMarkerClickListener {
    ...
    public void onClick(View v) {
        ...
        String url = getDirectionsUrl(loc, loc);
